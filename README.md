...
```text
https://jitpack.io/#xman24477/xnet-hub-theme/1.1.24
```
...
```gradle
dependencies {
    implementation 'com.github.xman24477:xnet-hub-theme:1.1.24'
}
```
...
### Animation Toggle (Version 1.1.24 Update)
ভার্সন `1.1.24` থেকে আপনি চাইলে X-Cyber থিমের হেভি ব্যাকগ্রাউন্ড অ্যানিমেশন (আর্ক, স্টার) কোডের মাধ্যমে চালু বা বন্ধ করতে পারবেন। এটি পারফরম্যান্স এবং ব্যাটারি সেভ করতে সাহায্য করে।
