...
public class XnetThemeManager {
    ...
    public static final int[] RGB_ACCENTS = new int[] {
            Color.parseColor("#00FF41"), // Neon Green
            Color.parseColor("#00D4FF"), // Cyber Cyan Blue
            Color.parseColor("#FF6B00"), // Amber Orange
            Color.parseColor("#E000FF"), // Electric Magenta
            Color.parseColor("#FFDF00")  // Neon Yellow
    };
    ...
    public static void applyThemeToActivity(Context context) {
        ...
        switch (theme) {
            ...
            case THEME_SYSTEM:
            default:
                styleResId = R.style.Theme_XnetCore_DayNight;
                break;
        }
    ...
    private static void traverseAndRandomizeRGB(View view, Random random) {
        ...
        if (view instanceof MaterialButton) {
            ...
            int accentColor = RGB_ACCENTS[random.nextInt(RGB_ACCENTS.length)];
    ...
    public static void applyHexPopupBackground(Context context, Spinner spinner) {
        try {
            ...
            if (THEME_CYBER_RGB.equals(getTheme(context))) {
                ...
                strokeColor = RGB_ACCENTS[r.nextInt(RGB_ACCENTS.length)];
            } else {
